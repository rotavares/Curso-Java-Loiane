	...
	public static void main(String[] args) {
		...
		while (!sair) {
			...
			case 1: // adicionar compromisso
				System.out.println(
						"Digite o número do mês (1 - 12), dia (1 - 31) e hora (1 - 8) para adicionar o compromisso");
				...
				while (mes < 1 && mes > 12 && dia < 1 && dia > 31 && hora < 7 && hora > 17) {
					...
					System.out.println(
							"Não foi possível acessar a data informada, digite o ano, dia e hora corretamente");
			...
			case 2: // editar compromissos
				System.out.println(
						"Digite o número do mês (1 - 12), dia (1 - 31) e hora (1 - 8) para editar o compromisso");
					...
					for (int j = 0; j < agendaPessoal[i].length; j++) {
						...
						for (int k = 0; k < agendaPessoal[i][j].length; k++) {
							...
							if (agendaPessoal[i][j][k] != null) {
								...
								System.out.print("No mês " + (i + 1) + ", Dia " + (j + 1) + " às " + k + "h"
										+ agendaPessoal[i][j][k]);
